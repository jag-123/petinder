...
/***/ function(module, exports, __webpack_require__) {
	...
	var md5 = __webpack_require__(87); // for hashing api signatures
	...
	var PeTinder = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(GetPet, null)
	    );
	  }
	});
	...
	var GetPet = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { type: 'button', value: 'get a pet', onClick: this.randomPet })
	    );
	  }
	});
